...
import { SearchModernComponent } from 'app/fuse/main/pages/search/modern/search-modern.component';
import { SearchModernService } from 'app/fuse/main/pages/search/modern/search-modern.service';
