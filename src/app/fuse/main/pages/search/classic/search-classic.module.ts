...
import { SearchClassicComponent } from 'app/fuse/main/pages/search/classic/search-classic.component';
import { SearchClassicService } from 'app/fuse/main/pages/search/classic/search-classic.service';
