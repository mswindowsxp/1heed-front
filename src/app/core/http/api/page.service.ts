...
export class PageService {
    ...
    public apiFacebookPagesPost(
        body?: RegisterPageRequest,
        observe?: 'response',
        reportProgress?: boolean
    ): Observable<HttpResponse<RegisterPageResponse>>;
    public apiFacebookPagesPost(
        body?: RegisterPageRequest,
        observe?: 'events',
        reportProgress?: boolean
    ): Observable<HttpEvent<RegisterPageResponse>>;
    public apiFacebookPagesPost(body?: RegisterPageRequest, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
        ...
        return this.httpClient.post<RegisterPageResponse>(`${this.basePath}/api/facebook/pages`, body, {
